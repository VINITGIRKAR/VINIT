...
with tab1:
    ...
    uploaded_file = st.file_uploader("Upload Resume (PDF)", type="pdf", help="Only PDF files are supported.")
    ...
    if submit:
        if uploaded_file is not None and jd:
            ...
            st.warning("⚠️ Please upload a PDF and paste the Job Description.")
